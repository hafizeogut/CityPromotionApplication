...
public class PopulationDistributionActivity extends AppCompatActivity {
    ListView listView;
    ...
    View adminTablePanel, btnCreate, btnDelete, btnUpdate;
    @Override
    ...
    private void hideAdminComponents() {
        ...
        populationText.setVisibility(View.GONE);
    ...
    public void logOut(View view) {
        ...
        Intent intent = new Intent(PopulationDistributionActivity.this, LoginActivity.class);
